...
class UsersTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('users')->insert([
            ...
            ['name' => 'Christopher Deodat', 'username' => 'chris_deodat', 'phone_number' => '081322850149', 'email' => 'christopher.deodat@gmail.com', 'address' => 'Jl. Sutera Jelita III, Alam Sutera, Pakulonan', 'ktp' => '36742808110002', 'npwp' => '07.138.086.5-474.000', 'password' => bcrypt('deodat81'), 'role' => 'user'],
        ]);
    }
}

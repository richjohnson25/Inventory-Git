...
class StockInTransactionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('stock_in_transactions')->insert([
            ...
            ['supplier_id' => 2, 'product_id' => 3, 'order_number' => 'P003', 'datetime' => '2023-03-04', 'quantity' => 30, 'price' => 60000, 'value' => 1621621, 'total_price' => 1800000, 'initial_quantity' => 0, 'initial_value' => 0, 'new_quantity' => 5, 'new_value' => 1621621, 'notes' => '', 'status' => 'pending'],
            ['supplier_id' => 3, 'product_id' => 4, 'order_number' => 'P004', 'datetime' => '2023-03-08', 'quantity' => 12, 'price' => 400000, 'value' => 4324324, 'total_price' => 4800000, 'initial_quantity' => 0, 'initial_value' => 0, 'new_quantity' => 5, 'new_value' => 4324324, 'notes' => '', 'status' => 'pending'],
        ]);
    }
}
